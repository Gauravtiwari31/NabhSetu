...
# Force live collection before Settings is constructed.
os.environ["APIX_DATA_MODE"] = "live"
os.environ.setdefault("APIX_EGRESS_MODE", "direct")
os.environ.setdefault("APIX_ENVIRONMENT", "live-run")
...
os.environ.setdefault("APIX_DATABASE_URL", "sqlite+aiosqlite:///./data/apix-live-retest2.db")
...
REPORT_PATH = Path("data/live-retest-report.json")
